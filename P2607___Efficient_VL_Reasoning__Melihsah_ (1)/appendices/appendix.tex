...
\makeatother
\renewcommand{\_}{\textunderscore\allowbreak}
\renewenvironment{longtable}[1]{\begin{tabular}{|p{0.065\textwidth}|p{0.095\textwidth}|p{0.045\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|p{0.06\textwidth}|p{0.10\textwidth}|p{0.045\textwidth}|p{0.065\textwidth}|}}{\end{tabular}}
\let\endhead\relax
\input{tables/appA_slices_v202_semantic.tex}
\endgroup
\end{table}
...
\begin{table}[p]
\centering
\caption[Full slice statistics, v2\_02, 40k, program-length slices.]{Full slice statistics, continued: v2\_02, 40k, program-length slices. Same quantities, uncertainty notation and caveats as Table~\ref{tab:appA-slices}.}
\label{tab:appA-slices-v202-program}
\begingroup\scriptsize\setlength{\tabcolsep}{1pt}
\makeatletter
\let\appAArrayParboxRestore\@arrayparboxrestore
\def\@arrayparboxrestore{\appAArrayParboxRestore\raggedright\let\\\tabularnewline}
...
\renewenvironment{longtable}[1]{\begin{tabular}{|p{0.065\textwidth}|p{0.095\textwidth}|p{0.045\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|p{0.06\textwidth}|p{0.10\textwidth}|p{0.045\textwidth}|p{0.065\textwidth}|}}{\end{tabular}}
\let\endhead\relax
\input{tables/appA_slices_v202_program.tex}
\endgroup
\end{table}
...
\begin{table}[p]
\centering
\caption[Full slice statistics, v2\_02, 40k, structural slices.]{Full slice statistics, continued: v2\_02, 40k, structural slices. Same quantities, uncertainty notation and caveats as Table~\ref{tab:appA-slices}.}
\label{tab:appA-slices-v202-structural}
\begingroup\scriptsize\setlength{\tabcolsep}{1pt}
\makeatletter
\let\appAArrayParboxRestore\@arrayparboxrestore
\def\@arrayparboxrestore{\appAArrayParboxRestore\raggedright\let\\\tabularnewline}
...
\renewenvironment{longtable}[1]{\begin{tabular}{|p{0.065\textwidth}|p{0.095\textwidth}|p{0.045\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|p{0.06\textwidth}|p{0.10\textwidth}|p{0.045\textwidth}|p{0.065\textwidth}|}}{\end{tabular}}
\let\endhead\relax
\input{tables/appA_slices_v202_structural.tex}
\endgroup
\end{table}
\clearpage
\begin{table}[p]
\centering
\caption[Full slice statistics, v2\_05c, 40k, five-seed mean.]{Full slice statistics, continued: v2\_05c, 40k, five-seed mean. Same quantities, uncertainty notation and caveats as Table~\ref{tab:appA-slices}.}
\label{tab:appA-slices-v205c-fiveseed}
\begingroup\scriptsize\setlength{\tabcolsep}{1pt}
\makeatletter
\let\appAArrayParboxRestore\@arrayparboxrestore
\def\@arrayparboxrestore{\appAArrayParboxRestore\raggedright\let\\\tabularnewline}
...
\renewenvironment{longtable}[1]{\begin{tabular}{|p{0.065\textwidth}|p{0.095\textwidth}|p{0.045\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|p{0.06\textwidth}|p{0.10\textwidth}|p{0.045\textwidth}|p{0.065\textwidth}|}}{\end{tabular}}
\let\endhead\relax
\input{tables/appA_slices_v205c_fiveseed.tex}
\endgroup
\end{table}
...
\begin{table}[p]
\centering
\caption[Full slice statistics, v2\_05c, 40k, seed 42.]{Full slice statistics, continued: v2\_05c, 40k, seed 42. Same quantities, uncertainty notation and caveats as Table~\ref{tab:appA-slices}.}
\label{tab:appA-slices-v205c-seed42}
\begingroup\scriptsize\setlength{\tabcolsep}{1pt}
\makeatletter
\let\appAArrayParboxRestore\@arrayparboxrestore
\def\@arrayparboxrestore{\appAArrayParboxRestore\raggedright\let\\\tabularnewline}
...
\renewenvironment{longtable}[1]{\begin{tabular}{|p{0.065\textwidth}|p{0.095\textwidth}|p{0.045\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.19\textwidth}|p{0.06\textwidth}|p{0.10\textwidth}|p{0.045\textwidth}|p{0.065\textwidth}|}}{\end{tabular}}
\let\endhead\relax
\input{tables/appA_slices_v205c_seed42.tex}
\endgroup
\end{table}
