"""Run the VE-0 evidence-contract tests.
...
established this by observation rather than assumption and shipped
tests/run_closure.py for the same reason; VE-0 follows the same pattern.
...
globs tests/*.py, so these test sources are still covered by it without any
edit to the sealed file.
"""
...
from tests import test_ve0  # noqa: E402
...
def main() -> int:
    ...
    if failures:
        ...
        return 1
    print("all VE-0 test modules passed")
    return 0
